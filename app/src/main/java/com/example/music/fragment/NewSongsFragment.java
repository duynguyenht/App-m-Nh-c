...
public class NewSongsFragment extends Fragment {
    ...
    private FragmentNewSongsBinding mFragmentNewSongsBinding; // Binding cho layout của fragment
    private List<Song> mListSong; // Danh sách các bài hát mới
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        getListNewSongs(); // Lấy danh sách bài hát mới từ Firebase
        initListener(); // Khởi tạo các sự kiện lắng nghe
        ...
        MyApplication.get(getActivity()).getSongsDatabaseReference().addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    // Kiểm tra nếu bài hát là bài hát mới thì thêm vào danh sách
                    if (song.isLatest()) {
                        mListSong.add(0, song);
                    }
                }
                displayListNewSongs(); // Hiển thị danh sách bài hát mới
            }
    ...
    private void displayListNewSongs() {
        ...
        // Thiết lập RecyclerView hiển thị danh sách bài hát mới
    ...
    private void goToSongDetail(@NonNull Song song) {
        // Xóa danh sách bài hát hiện tại và phát bài hát được chọn
    ...
    private void initListener() {
        ...
        // Sự kiện khi bấm vào nút "Phát tất cả"
